...
public class HistoryUsePointResponse extends BaseResponse {

    /**
     * data : {"totalCount":0,"items":[{"transactionCode":"string","membershipId":0,"membershipCardNumber":"string","benefitTypeId":0,"benefitTypeName":"string","transactionDate":"2018-11-29T02:23:16.371Z","type":"string","points":0,"userChange":"string","isActive":true,"id":0}]}
     */
    ...
    public static class Data {
        /**
         * totalCount : 0
         * items : [{"transactionCode":"string","membershipId":0,"membershipCardNumber":"string","benefitTypeId":0,"benefitTypeName":"string","transactionDate":"2018-11-29T02:23:16.371Z","type":"string","points":0,"userChange":"string","isActive":true,"id":0}]
         */
        ...
        public static class Items implements History {
             ...
             * transactionDate : 2018-11-29T02:23:16.371Z
             * type : string
             * points : 0
             * userChange : string
             * isActive : true
            ...
            public Pair<String, String> getPreviewDataFirst() {
                return new Pair<>("card_history_use_point_title_first", getTransactionCode());
            }

            @Override
            public Pair<String, String> getPreviewDataSecond() {
                return new Pair<>("card_history_use_point_title_second", getCardNumber());
            }

            @Override
            public Pair<String, String> getPreviewDataThird() {
                return new Pair<>("card_history_use_point_title_third", getRankName());
            }
        }
    }
}
