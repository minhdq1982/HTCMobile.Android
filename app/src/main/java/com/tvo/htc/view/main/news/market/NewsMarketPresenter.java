...
public class NewsMarketPresenter extends BasePresenter<NewsMarketContract.View> implements NewsMarketContract.Presenter {

    private List<News> mList;

    public NewsMarketPresenter(Context context) {
        super(context);
    }
    ...
    public void loadData(int skipCount, boolean refreshing) {
        ...
        RESTManager.getInstance().getProductList(skipCount, AppConstants.PAGE_LIMIT,
