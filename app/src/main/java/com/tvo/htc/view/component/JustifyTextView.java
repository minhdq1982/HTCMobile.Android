...
public class JustifyTextView extends TextView {
    ...
    // ArrayList of Strings that will contain the words of the sentence being
    // processed
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // This class won't justify the text if the TextView has wrap_content as
        // width
        ...
        if (params.width != ViewGroup.LayoutParams.WRAP_CONTENT
                && viewWidth >= 300 && words.length > 0
                && justifiedText.equals("")) {
            ...
            for (String word : words) {
                ...
                if ((sentenceWidth + mPaint.measureText(word)) < viewWidth) {
                    ...
                    insertWhiteSpaces(whiteSpacesNeeded, wordsInThisSentence,
                            temporalLine);
                    justifiedText += joinWords(temporalLine);
                    resetLineValues();
    ...
    // Method that inserts spaces into the words to make them fix perfectly in
    // the width of the view. I know I'm a genius naming stuff :)
    private void insertWhiteSpaces(int whiteSpacesNeeded,
                                   int wordsInThisSentence, ArrayList<String> sentence) {
        ...
        if (whiteSpacesNeeded == wordsInThisSentence) {
            ...
            // I was using recursion to achieve this... but when you tried to
            // watch the preview,
            // Android Studio couldn't show any preview because a StackOverflow
            // happened.
